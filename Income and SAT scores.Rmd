...
all_scores_final_instn<-final_converted_scores%>%
...
all_scores_final_DSTRCT<-final_converted_scores2%>%
  full_join(new_scale_scores)
```
...
```{r}
aggregate_scores_dist<-all_scores_final_DSTRCT%>%
  group_by(SCHOOL_DISTRCT_CD, DSTRCT_AVG_SCORE_VAL, score, new_score)%>%
